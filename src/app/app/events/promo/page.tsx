  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 px-4">
      <fieldset className="fieldset bg-purple-900 border-base-300 rounded-box w-full max-w-xs border p-6">
        ...
        {/* Discount Value */}
        <label className="label text-white mt-4">Discount Value (%)</label>
        <input
          type="number"
          className="input"
        ...
        {/* Available Coupon */}
        <label className="label text-white mt-4">Available Coupon</label>
        <input
          type="number"
          className="input"
        ...
        <input type="datetime-local" className="input" name="startDate" />
...
export default AuthGuard(CreatePromo, ["EVENT_ORGANIZER"]);
